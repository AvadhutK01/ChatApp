...
chatRouter.post('/get-status', authnticateUser, chatController.getStatus);
chatRouter.post('/set-status', authnticateUser, chatController.setStatus);
...
chatRouter.post('/actionOnContact', authnticateUser, chatController.performActionToContact);
